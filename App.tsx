...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden font-quicksand selection:bg-indigo-200 selection:text-indigo-900">
        ...
        <div className="fixed inset-0 pointer-events-none z-0 transform-gpu will-change-transform">
          <div className="absolute -top-[20%] -right-[10%] w-[70vw] h-[70vw] rounded-full bg-purple-200/40 blur-[80px] mix-blend-multiply opacity-70" />
          <div className="absolute -bottom-[20%] -left-[10%] w-[60vw] h-[60vw] rounded-full bg-indigo-200/40 blur-[80px] mix-blend-multiply opacity-70" />
          <div className="absolute top-[40%] left-[30%] w-[40vw] h-[40vw] rounded-full bg-amber-100/40 blur-[60px] mix-blend-multiply opacity-50" />
